...
# ================== Initialization ===================== #
DOC_MD_DAG = """
DAG template with create_dag function from variables
...
class ConstDag:
    ...
    dag_schedule = None
    tags = ["create_dag_from_variables", "template", "dynamic"]

tables_from_var = Variable.get("tables_for_processing")
TABLE_NAMES = json.loads(tables_from_var)
